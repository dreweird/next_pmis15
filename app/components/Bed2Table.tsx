...
const Bed2Component: React.FC<ResultComponentProps> = ({
  selectedValue,
  locked,
}) => {
  ...
  const [colDefs, setColDefs] = useState<(ColDef | ColGroupDef)[]>([
    ...
    {
      headerName: "BED 2 - Physical Accomplishment",
      marryChildren: true,
      children: [
        {
          headerName: "Jan",
        ...
        },
        {
          headerName: "Q1",
          type: "quarterColumn2",
          valueGetter: custom.Q1_PhysicalA,
          colId: "Q1_pa",
          cellClass: ["data", "a"],
        },
        {
        ...
        },
        {
          headerName: "Q2",
          type: "quarterColumn2",
          valueGetter: custom.Q2_PhysicalA,
          colId: "Q2_pa",
          cellClass: ["data", "a"],
        },
        {
        ...
        },
        {
          headerName: "Q3",
          type: "quarterColumn2",
          valueGetter: custom.Q3_PhysicalA,
          colId: "Q3_pa",
          cellClass: ["data", "a"],
        },
        {
        ...
        },
        {
          headerName: "Q4",
          type: "quarterColumn2",
          valueGetter: custom.Q4_PhysicalA,
          colId: "Q4_pa",
          cellClass: ["data", "a"],
        },
        {
          ...
          type: "numericColumn",
          colId: "PA",
          valueGetter: custom.GrandTotal_PhysicalA,
          width: 110,
          cellClass: ["data", "total"],
          cellStyle: (params) => {
            if (params.node.group) {
      ...
      children: [
        {
          ...
          cellEditorParams: { maxLength: "2000", cols: "50", rows: 6 },
          cellClass: ["data"],
        },{
          headerName: "Feb",
          field: "remarks_feb",
  ...
  const getRowId = (params: { data: { mfo_id: any } }) =>
    params.data.mfo_id.toString();
