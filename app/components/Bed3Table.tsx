...
const Bed3Component: React.FC<ResultComponentProps> = ({ selectedValue }) => {

    const gridRef = useRef<AgGridReact>(null); // Optional - for accessing Grid's API
    const [rowData, setRowData] = useState<any[]>([]);
    const { data: session } = useSession()
    const type: number = Number(session?.user?.email); // Only Disburse Account can update the disburse accomplishment
      ...
      children: [
        {
          ...
          children: [
            {headerName: "MOOE", field: "jana_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "jana_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "feba_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "feba_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "mara_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "mara_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "apra_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "apra_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "maya_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "maya_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "juna_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "juna_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "jula_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "jula_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "auga_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "auga_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "sepa_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "sepa_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "octa_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "octa_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "nova_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "nova_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          ...
          children: [
            {headerName: "MOOE", field: "deca_ot", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "deca_otc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
      ...
      children: [
        {
          headerName: 'Jan', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "jana_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "jana_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Feb', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "feba_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "feba_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Mar', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "mara_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "mara_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Apr', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "apra_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "apra_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'May', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "maya_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "maya_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Jun', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "juna_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "juna_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Jul', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "jula_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "jula_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Aug', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "auga_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "auga_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Sep', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "sepa_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "sepa_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Oct', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "octa_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "octa_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Nov', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "nova_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "nova_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
        ...
        },
        {
          headerName: 'Dec', columnGroupShow: 'open',
          children: [
            {headerName: "MOOE", field: "deca_dt", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
            {headerName: "CO", field: "deca_dtc", columnGroupShow: "open", type: 'valueColumn',  cellClass: ['data'],  editable: () => type == 8},
