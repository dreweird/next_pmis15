...
export function create_totalABC(a: number,b: number, c: number){
  ...
  export function create_total(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) {
    return {
      a: a,
      b: b,
      c: c,
  ...
  export function create_total2(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number,m: number) {
    return {
      a: a,
      b: b,
      c: c,
 ...
 export function TotalYearAggFunc(params: any) {
    ...
    params.values.forEach(function(value: { a: number; b: number; c: number; d: number; e: number; f: number; g: number; h: number; i: number; j: number; k: number; l: number }) {
      if (value && value.a) {
        a += value.a;
      }
      if (value && value.b) {
  ...
  export function TotalYearAggFunc2(params: any) {
    ...
    params.values.forEach(function(value: { a: number; b: number; c: number; d: number; e: number; f: number; g: number; h: number; i: number; j: number; k: number; l: number; m: number }) {
      if (value && value.a) {
        a += value.a;
      }
      if (value && value.b) {
...
export function GrandTotalAggFunc(params: any) {
    var [a, b, c, d] = [0,0,0,0];
    params.values.forEach(function(value: { a: number; b: number; c: number; d: number }) {
      if (value && value.a) {
        a += value.a;
      }
      if (value && value.b) {
...
export function Q1_PhysicalA(params: any) {
  if (!params.node.group) {
    if (params.data.main) {
      return -Math.abs((params.data.jan_pa + params.data.feb_pa + params.data.mar_pa) / 3);
    } else {
      return create_totalABC(
        params.data.jan_pa,
        params.data.feb_pa,
...
export function Q2_PhysicalA(params: any) {
  if (!params.node.group) {
    if (params.data.main) {
      return -Math.abs((params.data.apr_pa + params.data.may_pa + params.data.jun_pa) / 3);
    } else {
      return create_totalABC(
        params.data.apr_pa,
        params.data.may_pa,
...
export function Q3_PhysicalA(params: any) {
  if (!params.node.group) {
    if (params.data.main) {
      return -Math.abs((params.data.jul_pa + params.data.aug_pa + params.data.sep_pa) / 3);
    } else {
      return create_totalABC(
        params.data.jul_pa,
        params.data.aug_pa,
...
export function Q4_PhysicalA(params: any) {
  if (!params.node.group) {
    if (params.data.main) {
      return -Math.abs((params.data.oct_pa + params.data.nov_pa + params.data.dec_pa) / 3);
    } else {
      return create_totalABC(
        params.data.oct_pa,
        params.data.nov_pa,
...
export function GrandTotal_PhysicalA(params: any) {
  if (!params.node.group) {
    if (params.data.main) {
      return -Math.abs((params.getValue('Q1_pa') + params.getValue('Q2_pa') + params.getValue('Q3_pa') + params.getValue('Q4_pa')) / 4);
    } else {
      return create_totalABCD(
...
export function customStyleGroupQuarter(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': '#a2dde5', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': '#a2dde5', 'fontWeight': 'normal'};
  }
}

export function customStyleGroupTotal(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': '#F5f5dc', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': '#F5f5dc', 'fontWeight': 'normal'};
  }
}

export function customStyleGroupQaurter2(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': '#fae091', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': '#fae091', 'fontWeight': 'normal'};
  }
}

export function customStyleGroupQaurter3(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': '#e8eb34', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': '#e8eb34', 'fontWeight': 'normal'};
  }
}

export function customStyleGroupDisburse(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': '#ffaff8', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': '#ffaff8', 'fontWeight': 'normal'};
  }
}

export function customStyleGroupDisburse2(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': '#ADD8E6', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': '#ADD8E6', 'fontWeight': 'normal'};
  }
}

export function customStyleGroupPhysical(params: any){
  if(params.node.group){
    return { 'textAlign': 'right', 'color': 'black','backgroundColor': 'orange', 'fontWeight': 'bold' };
  }else{
    return {  'textAlign': 'right','color': 'black','backgroundColor': 'orange', 'fontWeight': 'normal'};
  }
}

export function currencyFormatter(params: { value: number | null | undefined; }) {
